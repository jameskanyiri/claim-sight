...
class FeatureOutput(BaseModel):
    """
    Complete feature engineering output for a single claim.
    Produced by the compute_features node in the adjudication pipeline.
    """

    claim_id: str = Field(description="ID of the claim being analysed.")
